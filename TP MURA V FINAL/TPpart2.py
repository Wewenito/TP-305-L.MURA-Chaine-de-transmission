...
class TPpart2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TPpart2")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 480.E3
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_1_win, 1, 1, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 110.7E3, 1, 0, 0)
        self.analog_sig_source_x_0_0_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 9000, (1/2), 0, 0)
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 10.7e3, 1, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 100.E3, 1, 0, 0)
        self.analog_sig_source_x_0_0_0.set_block_alias("OSCILLATEUR HETERODYNE")
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 89.3E3, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1000, (1/2), 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_1, 0), (self.blocks_add_xx_0_0, 1))
        ...
        self.connect((self.blocks_add_xx_0_0, 0), (self.qtgui_freq_sink_x_0_1, 0))
        self.connect((self.blocks_add_xx_0_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))
...
def main(top_block_cls=TPpart2, options=None):
